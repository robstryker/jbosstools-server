...
public class TrueZipUtil {
	...
	public static de.schlichtherle.io.File getFile(java.io.File file, ArchiveDetector detector) {
		...
		try {
			Thread.currentThread().setContextClassLoader(bundleLoader);
			//  FILL CODE HERE
			return new de.schlichtherle.io.File(file, detector);
		} finally {
			Thread.currentThread().setContextClassLoader(originalTCCL);
		}
	}
	
	public static de.schlichtherle.io.File getFile(java.io.File file, String child, ArchiveDetector detector) {
		...
		try {
			Thread.currentThread().setContextClassLoader(bundleLoader);
			//  FILL CODE HERE
			return new de.schlichtherle.io.File(file, child, detector);
		} finally {
			Thread.currentThread().setContextClassLoader(originalTCCL);
		}
	}
	...
	public static ArchiveDetector getDefaultArchiveDetector() {
		...
		try {
			Thread.currentThread().setContextClassLoader(bundleLoader);
			//  FILL CODE HERE
			return ArchiveDetector.DEFAULT;
		} finally {
			Thread.currentThread().setContextClassLoader(originalTCCL);
		}
	}
