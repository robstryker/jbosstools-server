...
public class AttributeControlFactory {
	...
	static {
		...
		IExtensionPoint epDisplays =
				registry.getExtensionPoint("org.jboss.tools.jmx.ui.attribute.controls"); //$NON-NLS-1$
				...
				IExtensionPoint bindings =
						registry.getExtensionPoint("org.jboss.tools.jmx.ui.attribute.bindings"); //$NON-NLS-1$
