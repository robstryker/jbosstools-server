 ...
 *******************************************************************************/
package org.jboss.tools.jmx.jvmmonitor.internal.core.cpu;
...
public class CpuProfiler implements ICpuProfiler {
    ...
    private static final String PROFILER_MXBEAN_NAME = "org.jboss.tools.jmx.jvmmonitor:type=CPU BCI Profiler"; //$NON-NLS-1$
